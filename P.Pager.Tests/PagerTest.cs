...
namespace P.Pager.Tests
{
    public class PagerTest
    {
        ...
        public void StartPageTest()
        {
            ...
            var firstPage = list.ToPagedList(1, 20); // first page from 1 to 20, page size = 20
        ...
        public void MiddlePageTest()
        {
            ...
            var secondPage = list.ToPagedList(2, 20); // second page from 21 to 40, page size = 20
        ...
        public void LastPageTest()
        {
            var list = Enumerable.Range(1, 200).ToList();
            var expectedList = Enumerable.Range(21, 20).ToList(); // get list from 21 to 40
            var lastPage = list.ToPagedList(10, 20); // second page is last page
        ...
        public void InvalidPageTest()
        {
            ...
            var validPage = list.ToPagedList(12, 20); // Here totalPageCount is 10 but takes Index as 12
        ...
        public void NextPageCheck()
        {
            var list = Enumerable.Range(1, 200).ToList();
            var expectedList = Enumerable.Range(21, 20).ToList(); // get list from 21 to 40
            var page = list.ToPagedList(1, 20); // second page from 21 to 40, page size = 20
